...
@section('content')
    ...
    <form action="{{ route('catch.store', $product) }}" method="POST" class="flex flex-col space-y-4 p-4 bg-white rounded-md border border-gray-300">
        ...
        <select name="logistic_class" id="logistic_class" class="appearance-none bg-gray-100 rounded-md shadow-md border border-gray-300 focus:ring ring-blue-300 text-black px-4 py-2 w-full">
